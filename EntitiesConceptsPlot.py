...
class EntitiesConceptsPlot():
    """!
    EntitiesConceptsPlot class which contains generic methods to do plots of OpenAlex entities
    """
...
class WorksConceptsPlot(EntitiesConceptsPlot, WorksConceptsAnalysis):
    """!
...
class AuthorsConceptsPlot(EntitiesConceptsPlot, AuthorsConceptsAnalysis):
    pass


class SourcesConceptsPlot(EntitiesConceptsPlot, SourcesConceptsAnalysis):
    pass


class InstitutionsConceptsPlot(EntitiesConceptsPlot, InstitutionsConceptsAnalysis):
    """!
...
class ConceptsConceptsPlot(EntitiesConceptsPlot, ConceptsConceptsAnalysis):
    pass


class PublishersConceptsPlot(EntitiesConceptsPlot, PublishersConceptsAnalysis):
    pass