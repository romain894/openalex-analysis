...
class WorksConceptsAnalysis(EntitiesConceptsAnalysis, Works):
    ...
    def create_element_used_count_array(self, element_type, entities_from = [], out_file_name = None, save_out_array = False, count_years = []):
        ...
        for i, entitie in enumerate(entities_from):
            ...
            # initialise the WorksConceptsAnalysis instance
            works = WorksConceptsAnalysis(**entitie, load_only_columns=cols_to_load)
...
class AuthorsConceptsAnalysis(EntitiesConceptsAnalysis, Authors):
    EntitieOpenAlex = Authors
    

class SourcesConceptsAnalysis(EntitiesConceptsAnalysis, Sources):
    EntitieOpenAlex = Sources


class InstitutionsConceptsAnalysis(EntitiesConceptsAnalysis, Institutions):
    """!
...
class ConceptsConceptsAnalysis(EntitiesConceptsAnalysis):
    EntitieOpenAlex = Concepts


class PublishersConceptsAnalysis(EntitiesConceptsAnalysis):
